...
**Response:** This defense misinterprets the purpose of *scalable* pilot design. The argument is not that a 50-home pilot must single-handedly build a state-wide workforce pipeline. Rather, the pilot must be deliberately structured to gather empirical data on the *assumptions* that will govern future scale. If a pilot achieves success only by bypassing standard market channels (such as using an elite, subsidized engineering firm instead of standard local contractors) it has tested an unrealistic scenario. It becomes a boutique demonstration project that fails to generate actionable insights for broad deployment. A pilot is valuable only when it tests a scalable delivery design, a viable financing mechanism, or an adaptable operational workflow.
...
Singh, J. (2016). *Why Energy Efficiency Matters and How to Scale It Up.* World Bank, Washington, DC. [https://doi.org/10.1596/23636](https://doi.org/10.1596/23636)
